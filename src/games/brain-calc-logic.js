...
function brainCalc() {
  ...
  let counter = 0;
  let answer, number1, number2, operationCode, correctAnswer, task, gameQuestion;
  ...
  while (counter < 3) {
    ...
    gameQuestion = "Question: " +   number1.toString() +   " " + chooseSignAtCalcQuestion(operationCode) +  " " +  number2.toString() +  " ";
